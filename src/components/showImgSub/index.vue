                ...
                <div>
                    ...
                    <div class="bg_img flex" v-show="showBgList">
                        <div class="title flex a-i">
                            ...
                            <el-button round icon="el-icon-upload2" style="margin-left:30px;font-size: 12px;line-height: 28px;border-color: #e82255;padding: 0 8px;color: #e82255;" @click="upselfImg">Custom background</el-button>
