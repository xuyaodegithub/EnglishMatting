        ...
        <div class="margins flex j-b a-i first">
            <ul class="flex">
                ...
                <li class="cu" :class="{'red' : urls.indexOf('index')>-1 || urls.indexOf('/#/')>-1}">
                    <a href="index.html">Home</a></li><!--智能抠图-->
                <li class="cu" :class="{'red' : urls.indexOf('people')>-1}" @click="backindex()">Portrait Cutout</li><!--智能抠图-->
                <li class="cu" :class="{'reds' : urls.indexOf('objects')>-1}"><a href="objects.html">Object Cutout</a></li><!--智能抠图-->
                <li class="cu" :class="{'red' : urls.indexOf('product')>-1}"><a href="product.html">More Products</a></li>
<!--                @click="toProduct()" @click="toAbout()"-->
                <li class="cu" :class="{'red' : urls.indexOf('aboutUs')>-1}"><a href="aboutUs.html">About Us</a></li><!--会员-->
<!--                <li>|</li>-->
<!--                <li class="cu" :class="{'red' : urls.indexOf('freeimg')>-1}"><a href="freeimg.html">免费PNG透明图</a></li>-->
            ...
            <div class="right">
                <div v-if="!loginAfter">
                    ...
                    <span @click="userlogin(0)" class="active">Login/Registration</span><!--注册-->
                </div>
                <div class="cu" v-else>
                    <a href="docsify/#/apidoc_api.md"><span>API</span></a><!--登录-->
                    <span :class="{'red' : urls.indexOf('userVip')>-1}" @click="userCenter()">Pricing</span>
                    <el-dropdown placement="bottom-end" @command="handleCommand">
                      ...
                      <el-dropdown-menu slot="dropdown">
                         ...
                         <el-dropdown-item command="0">Sign out</el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
                </div>
            </div>
