...
<!--                    </div>-->
            ...
            <div class="OperatorRight drops">
                <div class="newChunk">
                    <h2>Object Cutout</h2>
                    <p>Cats, dogs, cars, shoes, bags, and houses</p>
                    <div class="flex a-i">
                        <div class="gif"><img src="../../assets/image/ogif.gif" alt=""></div>
                        <div class="gifright">
                            <el-button type="primary" round icon="el-icon-upload2" @click="upLoadimg()" style="background-color: #21a9e8;border-color: #21a9e8;"><!--Upload-->Upload Image</el-button>
                            <el-input v-model="imgUrl"  placeholder="Paste (CTRL+V) image or URL"
