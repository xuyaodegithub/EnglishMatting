    ...
    <div class="editPictures flex">
        ...
        <div class="e_c">
            ...
            <div class="second" v-show="selectType===1">
                ...
                <el-button type="primary" plain style="width: 100%" @click="$refs.selfImg.click()">Custom background</el-button>
        ...
        <div class="e_r" id="e_r" @click="showDa=false">
            <div class="r_h flex a-i">
                ...
                <div class="flex c_input">
                    ...
                    <div><input type="number" v-model="pxWidth" @input="changeSize(1)"><i>width(px)</i></div>
                    <div><input type="number" v-model="pxHeight" @input="changeSize(2)"><i>height(px)</i></div>
                </div>
                <el-button type="primary" icon="el-icon-download" @click="downLoadImg">download</el-button>
            </div>
            <div class="canvas" ref="canvasM" :style="{width:`${pxWidth}px`,height:`${pxHeight}px`}" @mousedown.stop="down" @click.stop="showDa=true"  :class="{active : showBorder}">
                <canvas id="b_g">This function is not supported by the current Tourer. Try another one!</canvas>
                <canvas id="b_p">This function is not supported by the current Tourer. Try another one!</canvas>
    ...
    export default {
        ...
        data() {
            return {
                ...
                choseBack: 0,
                showcolorList: false,
                bgBtn: ['Photography','Hand drawn','Color'],
                bgType: 0,
                selectIdx: -1,
